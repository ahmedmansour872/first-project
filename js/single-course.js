$(document).ready(function(){
    ...
    /*start tab in page single course*/

    $(".contant .main-contant .course-sammary .tab li").click(function(){
        $(this).addClass("active").siblings().removeClass("active");

        $(".contant .main-contant .course-sammary > div").hide();

        $("#"+$(this).attr("id")+"-contant").fadeIn(0);
    })
    /*end tab in page single course*/

    $(".course-sammary  .course-down .head").click(function(){
       $(".course-sammary  .course-down .bod").slideToggle();
            $(".course-sammary  .course-down .head i").toggleClass("fa-chevron-down fa-chevron-up");
    })

    $(".course-sammary  .course-down .head2").click(function(){
        $(".course-sammary  .course-down .bod2").slideToggle();
             $(".course-sammary  .course-down .head2 i").toggleClass("fa-chevron-down fa-chevron-up");
     })

    $(".course-sammary  .course-down .head3").click(function(){
        $(".course-sammary  .course-down .bod3").slideToggle();
             $(".course-sammary  .course-down .head3 i").toggleClass("fa-chevron-down fa-chevron-up");
     })
